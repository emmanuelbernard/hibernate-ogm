...
[NOTE]
====
Remember to use MongoDB's http://docs.mongodb.org/manual/reference/mongodb-extended-json/[strict mode]
when writing queries using the MongoDB CLI syntax.
In particular, put the attribute names in quotes.

To make them more readable, use single quotes.
====
